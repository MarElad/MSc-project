...
if __name__ == "__main__":
    ...
    r5 = keras.layers.Reshape((10,10,n_frames))(r4)
    print('r5 shape', r5.shape)
    r6 = keras.layers.Convolution2D(16, kernel_size=1, strides=1, activation='relu', padding='same')(r5)
    print('r6 shape', r6.shape)
    r7 = keras.layers.Convolution2D(32, kernel_size=1, strides=1, activation='relu', padding='same')(r6)
    print('r7 shape', r7.shape)
    r8 = keras.layers.Convolution2D(64, kernel_size=1, strides=1, activation='relu', padding='same')(r7)
    print('r8 shape', r8.shape)
    out0 = keras.layers.Convolution2D(1, kernel_size=1, strides=1, activation='sigmoid', padding='same')(r8)
    print('out0', out0.shape)
    out1 = keras.layers.Convolution2D(1, kernel_size=1, strides=1, activation='relu', padding='same')(r8)
