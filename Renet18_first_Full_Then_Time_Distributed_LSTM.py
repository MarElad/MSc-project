...
if __name__ == "__main__":
    ...
    cnv1 = keras.layers.Convolution2D(n_frames*16, kernel_size=3, strides=1, activation='relu', input_shape=(n_frames, img_rows, img_cols, 1), padding='same')(inp)
    print('cnv1 shape', cnv1.shape)
    cnv1 = keras.layers.Reshape((n_frames, img_rows, img_cols, -1))(cnv1)
    print('cnv1 reshape', cnv1.shape)
